 ...
 * <p>
 * The purpose of this class is to avoid the need to write code to handle maps
 * of maps. An example might be the need to lookup a filename by key and locale.
 * The typical solution might be nested maps. This class can be used instead by
 * creating an instance passing in the key and locale.
 * <p>
 * Example usage:
 * 
 * <pre>
...
public class MultiKey implements Serializable {
	 ...
	 * changed after adding to the MultiKey.
	 * 
	 * @param key1
	 *            the first key
	 * @param key2
	 ...
	 * <p>
	 * This method is public for performance reasons only, to avoid a clone. The
	 * hashcode is calculated once here in this method. Therefore, changing the
	 * array passed in would not change the hashcode but would change the equals
	 * method, which is a bug.
	 * <p>
	 * This is the only fully safe usage of this constructor, as the object
	 * array is never made available in a variable:
	 * 
	 * <pre>
