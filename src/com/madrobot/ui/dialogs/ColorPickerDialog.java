...
public class ColorPickerDialog {
	...
	public ColorPickerDialog(final Context context, int color, OnAmbilWarnaListener listener) {
		...
		final View view = LayoutInflater.from(context).inflate(com.madrobot.R.layout.color_picker_dialog, null);
		viewHue = view.findViewById(com.madrobot.R.id.ambilwarna_viewHue);
		viewSatVal = (ColorPickerView) view.findViewById(com.madrobot.R.id.ambilwarna_viewSatBri);
		viewCursor = (ImageView) view.findViewById(com.madrobot.R.id.ambilwarna_cursor);
		viewOldColor = view.findViewById(com.madrobot.R.id.ambilwarna_warnaLama);
		viewNewColor = view.findViewById(com.madrobot.R.id.ambilwarna_warnaBaru);
		viewTarget = (ImageView) view.findViewById(com.madrobot.R.id.ambilwarna_target);
		viewContainer = (ViewGroup) view.findViewById(com.madrobot.R.id.ambilwarna_viewContainer);
