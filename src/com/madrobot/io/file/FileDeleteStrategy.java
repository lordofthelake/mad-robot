 ...
 * <p>
 * There is more than one way to delete a file. You may want to limit access to
 * certain directories, to only delete directories if they are empty, or maybe
 * to force deletion.
 * <p>
...
public class FileDeleteStrategy {
	 ...
	 * <p>
	 * This method is designed for subclasses to override. The implementation
	 * may return either false or an <code>IOException</code> when deletion
	 * fails. The {@link #delete(File)} and {@link #deleteQuietly(File)} methods
	 * will handle either response appropriately. A check has been made to
